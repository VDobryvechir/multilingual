...
for lang in langs:
    ...
    dst = config["sources"]["flertallDictionary"].replace("[lang]",lang)
    ...
    allWords = [] 
    common.dvtextutils.extractPhrasesFromEntryMap(allWords, srcMap)
    allWords.sort()
    allSet = set(allWords)
...
print(f"enriching flertall dictionary successfully finished: {res}")
